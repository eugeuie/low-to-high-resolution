...
- [ ] получить исправленную выборку MODIS
  - [x] в той же проекции, как и у данных Sentinel
  - [ ] обрезанную по маске России
  - [ ] с исправленными метками классов
  - [ ] с прозрачным фоном
...
- [ ] перепроецировать маску России
- [ ] хранить выборку MODIS только внутри маски России
